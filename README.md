...
| `test_vkp.cpp` (43, 펌웨어) | 같은 프레임 규격을 C++ 쪽에서. CRC 검증값, 비트 전수 뒤집기, 무작위 손상 400만 건(1~3비트 200만 + 4~10비트 200만), 잡음 뒤 재동기화, 디바운스·길게 누름·떨림 가드 상태머신. |
